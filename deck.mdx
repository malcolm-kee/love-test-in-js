...
- how many is writing tests in work,
- how many writing tests for side projects.
...
Let me share with you how I used to hate writing tests, and why.
...
- And lastly, it's boring to write tests.
- Not creating, just repeating
- Maybe that's how writing tests catch bug?
...
<CodeSurfer
  ...
  steps={[
    ...
    {
      notes:
        'Unit test ≠ low effort, but that is not the biggest issue'
    }
  ]}
/>
...
<blockquote className="twitter-tweet">
  <p lang="en" dir="ltr">
    ...
    times a year, and I’m only able to do so because our test suite
